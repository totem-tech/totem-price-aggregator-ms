...
import { getCoinGeckoPrices } from './coinGeckoHelper'
...
const exec = async () => {
    ...
    if (updatedCurrencies.length) {
        ...
        await currenciesDB.setAll(new Map(updatedCurrencies), false)
    }
...
start()
    ; (async () => {
        // initiate global database connection
        // await getConnection(CouchDB_URL)
        // updateStockDailyPrices(dailyHistoryDB, currenciesDB)
    })()
